...
<div class="container" style="margin-top: 20px">
    <div class="row">
        ...
        <div class="col-md-6 menuItem">
            ...
            <a href="<?php echo base_url('Bidan_controller/show_edit_bidan_view/'.$_SESSION['id_pengguna'])?>"
               class="btn btn-primary waves-effect waves-dark" style="display: block;margin: auto;">Ubah</a></li>
        </div>
