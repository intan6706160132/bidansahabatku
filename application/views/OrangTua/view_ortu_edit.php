<section id="inner-headline">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="pageTitle">Edit Data Ortu</h2>
            </div>
        </div>
    </div>
</section>
<div class="container" style="margin-top: 20px">
    <div class="row">
        <!--        <div class="col-md-6">-->
        <form method=post name="sentMessage" id="contactForm" action="<?php echo base_url('Ortu_controller/update_data');?>" novalidate>
            <div class="col-sm-12">
                <div class="input-field">
                    <input type="text" name="ID_ORANG_TUA" class="form-control"
                           id="ID_ORANG_TUA" required
                           data-validation-required-message="Isikan ID" value="<?php echo $data_ortu['ID_ORANG_TUA']?>" readonly/>
                    <label> ID </label>
            ...
            <div class="row center-block">
                ...
                <div class="col-md-6">
                    <a href="<?php echo base_url('Ortu_controller/show_ortu_view/'.$_SESSION['id_pengguna'])?>">
