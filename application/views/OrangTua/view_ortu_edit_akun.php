                ...
                <div class="col-md-12">
                    <div class="input-field">
                        <input type="text" name="ID_ORANG_TUA" class="form-control"
                               ...
                               data-validation-required-message="Isikan ID" value="<?php echo $data_ortu['ID_ORANG_TUA']?>" readonly="readonly"/>
                        <label> ID </label>
...
<!--                </div>-->
                ...
                <div class="col-md-4">
                    <a href="<?php echo base_url('Ortu_controller/show_editpw_ortu_view/'.$_SESSION['id_pengguna'])?>">
